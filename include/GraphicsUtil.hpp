...
public:
    ...
    static void generate_tiles_map_nlohmann(spritesheet_pool& spritesheet_pool, tile_pool& tile_pool);
    static void generate_tiles_player(Spritesheet& spritesheet_player, tile_pool& tile_pool_player);
    static void generate_tiles_player_nlohmann(Spritesheet& spritesheet_player, tile_pool& tile_pool_player);
